...
describe('reporter/json-reporter', () => {
  ...
  it('should create a json file', () => {
    const results = {any: {id: '1', errors: 4, count: 7, avg100: 6, median100: 33, min100: 1, max100: 199, avg80: 6, median80: 33, min80: 12, max80: 99}};
    jsonReporter(results);
    expect(existsSync(file)).to.be.true;
  },);
  it('should create a json file with matching contents', () => {
    const results = {any: {id: '1', errors: 4, count: 7, avg100: 6, median100: 33, min100: 1, max100: 99, avg80: 76, median80: 33, min80: 14, max80: 99}};
    jsonReporter(results);
