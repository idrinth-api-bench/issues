...
const Usage = () => <div>
  ...
  <ul>
    <li>
        iabr (or run-benchmark) runs the current working directory's project if
        the routes folder is properly setup
      <ul>
    ...
    <li>
        iabmp (or make-benchmark-project) creates a new benchmarking project in
  ...
  <p>
      ...
      before_task, before_each, main, after_each, after_task, and after will be
      used to automatically fill the Job processed by the executor. Automatic
      filling only happens when there are no tasks provided to the function.
  </p>
</div>;
